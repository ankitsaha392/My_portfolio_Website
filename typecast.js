const carouselText = [
    ...
    {text: "I'm a Full Stack Web Developer", color: "#7f00ff"},
    {text: "I have knowledge about Java", color: "#7f00ff"},
    {text: "I have knowledge about Data Structure and algorithm", color: "#7f00ff"},
    {text: "I have knowledge about Database management system", color: "#7f00ff"},
    {text: "I have knowledge about Networking", color: "#7f00ff"}
